...
if TYPE_CHECKING:
    from poly_analysis.coordination_polyhedron import CoordinationPolyhedron
...
class Atom:
    ...
    def __init__(self,
        ...
        self.index = index
        self.site = site
        self.label: str = label if label else site.label
    ...
    def __repr__(self) -> str:
        return "{} {}".format(self.label, self.site)
